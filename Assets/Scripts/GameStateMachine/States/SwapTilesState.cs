...
namespace GameStateMachine.States
{
    public class SwapTilesState : IState, IDisposable
    {
        ...
        public SwapTilesState(IGrid grid, IStateSwitcher stateSwitcher, IAnimation animation)
        {
            _grid = grid;
        ...
        private void MoveAnimation(Tile tileToMove, Vector2Int position) =>
            _animation.MoveTile(tileToMove, _grid
                .GridToWorld(position.x, position.y),Ease.OutCubic);
